...
$link=conectarbd();
$sql_="INSERT INTO institucion(id_institucion,nombre,naturaleza,cod_municipio,direccion,telefono,director) values('0','$_POST[nombre]','$_POST[naturaleza]','$_POST[cod_municipio]','$_POST[direccion]','$_POST[telefono]','$_POST[director]')";
echo "<br>".$sql_;
$link->query($sql_);
...
<form name='form1' method="post" action="pp_institucion1.php">
