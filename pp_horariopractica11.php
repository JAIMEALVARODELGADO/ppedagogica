...
//require("pp_menu.php");
$link=conectarbd();
$sql_="INSERT INTO horario(id_horario,id_practica,id_dia,hora,id_asignatura,grado,grupo,jornada,nivel) VALUES (0,'$_POST[id_practica]','$_POST[id_dia]','$_POST[hora]','$_POST[id_asignatura]','$_POST[grado]','$_POST[grupo]','$_POST[jornada]','$_POST[nivel]')";
//echo "<br>".$sql_;
$link->query($sql_);
