...
$link=conectarbd();
$nombre='';
$consulta="SELECT id_asignatura,nombre FROM asignatura WHERE id_asignatura='$_GET[id_asignatura]'";
//echo "<br>".$consulta;
...
?>
<form name='form1' method="post" action="pp_asignatura211.php">    
    <?php
    require("pp_datos_asignatura.php");
    echo "<input type='hidden' name='id_asignatura' value='$_GET[id_asignatura]'/>";
    ?>
    <script language="JavaScript">
