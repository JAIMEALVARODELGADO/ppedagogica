...
$link=conectarbd();
$nombre='';
$consulta="SELECT id_programa,descripcion FROM programa WHERE id_programa='$_GET[id_programa]'";
//echo "<br>".$consulta;
...
?>
<form name='form1' method="post" action="pp_programa211.php">    
    <?php
    require("pp_datos_programa.php");
    echo "<input type='hidden' name='id_programa' value='$_GET[id_programa]'/>";
    ?>
    <script language="JavaScript">
